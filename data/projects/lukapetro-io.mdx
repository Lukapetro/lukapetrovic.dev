...
isPublished: false
color: bg-gradient-to-r from-[#6EE7B7] via-[#3B82F6] to-[#9333EA]
---
...
[lukapetrovic.dev](https://www.lukapetrovic.dev/) is born almost as a game at the beginning of the Covid epidemic and is the most concrete example of how to move forward when everything seems to stop.
