...
1.  [The 5 Ws (and 1 H)](/projects/lukapetro-io#the-5-ws-and-1-h)
2.  [Tech Stack](/projects/lukapetro-io#tech-stack)
3.  [Overview](/projects/lukapetro-io#overview)
4.  [Snippets](/projects/lukapetro-io#snippets)
5.  [Conclusion](/projects/lukapetro-io#conclusion)
6.  [Inspiration](/projects/lukapetro-io#inspiration)
...
- **When**: this portfolio was born in 2017. At the end of 2021 I decided to give it a more modern and fresh look ( as we will see in the [tech stack](/projects/lukapetro-io#tech-stack))
...
<Image
  alt={`lukapetro.io`}
  src={`/static/images/lukapetro-io/lukapetro-scaffolding.png`}
  width={901}
  height={225}
/>
...
- `data/*` - MDX data that is used for projects and changelogs.
